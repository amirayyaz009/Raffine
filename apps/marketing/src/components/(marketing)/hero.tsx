      ...
      <div className="relative">
            ...
            >
              ...
              >
                <img
                  ...
                  alt="Raffine - The open source DocuSign alternative | Product Hunt"
        ...
        >
          <Widget className="mt-12">
            <strong>Raffine Supporter Pledge</strong>
            ...
            <p className="w-full max-w-[70ch]">
              Through our platform, called Raffine, we strive to earn your trust by allowing
            ...
            <p className="w-full max-w-[70ch]">
              At Raffine, we envision a web-enabled future for business and contracts, and we are
            ...
            <p className="w-full max-w-[70ch]">
              ...
              signal your support of Raffine's mission{' '}
            ...
            <div>
              ...
              <p className="mt-1">Co-Founders, Raffine</p>
            </div>
          </Widget>
        </motion.div>
      </div>
